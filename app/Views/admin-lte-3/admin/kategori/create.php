                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kategori" id="kategori" class="form-control <?= session('errors.kategori') ? 'is-invalid' : '' ?>" value="<?= old('kategori') ?>" placeholder="Masukkan nama kategori" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode" id="kode" class="form-control <?= session('errors.kode') ? 'is-invalid' : '' ?>" value="<?= old('kode') ?>" placeholder="Masukkan kode kategori (opsional)">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="keterangan" id="keterangan" class="form-control <?= session('errors.keterangan') ? 'is-invalid' : '' ?>" rows="3" placeholder="Masukkan keterangan kategori (opsional)"><?= old('keterangan') ?></textarea>
