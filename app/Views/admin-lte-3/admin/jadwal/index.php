    ...
    <div class="col-12">
        <div class="card rounded-0">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <a href="<?= base_url('admin/jadwal/create') ?>" class="btn btn-sm btn-primary rounded-0">
                    ...
                    <tbody>
                        <?php foreach ($jadwal as $key => $row): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?= base_url("admin/jadwal/edit/$row->id") ?>"
                                            class="btn btn-warning btn-sm rounded-0">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url("admin/jadwal/delete/$row->id") ?>"
            ...
            <?php if ($pager): ?>
                <div class="card-footer clearfix">
                    <div class="float-right">
                        <?= $pager->links('jadwal', 'adminlte_pagination') ?>
                    </div>
                </div>
            <?php endif ?>
        </div>
