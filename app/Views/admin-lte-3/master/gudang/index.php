    ...
    <div class="col-12">
        <div class="card rounded-0">
            <div class="card-header">
                <div class="row">
                    <div class="col-md-6">
                        <a href="<?= base_url('admin/master/gudang/create') ?>" class="btn btn-sm btn-primary rounded-0">
                            <i class="fas fa-plus"></i> Tambah Data
                        </a>
                        <?php if ($trashCount > 0): ?>
                            <a href="<?= base_url('admin/master/gudang/trash') ?>" class="btn btn-sm btn-danger rounded-0">
                    ...
                    <tbody>
                        <?php foreach ($gudang as $key => $row): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="<?= base_url("admin/master/gudang/edit/$row->id") ?>"
                                            class="btn btn-warning btn-sm rounded-0">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <a href="<?= base_url("admin/master/gudang/delete/$row->id") ?>"
