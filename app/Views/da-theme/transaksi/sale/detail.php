                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="company-info">
                            <img src="<?= base_url($Pengaturan->logo_header) ?>" alt="<?= esc($Pengaturan->judul_app) ?>" style="max-height: 60px;">
                    ...
                    <div class="col-md-6 text-right">
                        ...
                        <p class="due-date">Jatuh Tempo: <?= date('d/m/Y', strtotime($order->invoice_date . ' +7 days')) ?></p>
                    </div>
                </div>
            </div>
                                        ...
                                        <td style="padding: 15px; border: 1px solid #ddd;">
                                            ...
                                            <?php if ($detail->item_data): ?>
                                                ...
                                                <?php if (isset($itemData['participant_name'])): ?>
                                                    <br><small class="text-muted">Peserta: <?= esc($itemData['participant_name']) ?></small>
                                                <?php endif; ?>
                                            <?php endif; ?>
                                        </td>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="summary-box">
                                <p><strong>Sisa Tagihan</strong> <span class="float-right">Rp <?= number_format($grandTotal - $totalPayments, 2, ',', '.') ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="transaction-section">
                ...
                <div class="payment-summary">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="summary-box">
                                <p><strong>Sisa Tagihan</strong> <span class="float-right">Rp <?= number_format($grandTotal, 2, ',', '.') ?></span></p>
                            </div>
                        </div>
                    </div>
                </div>
...
.recipient-info, .company-details {
    line-height: 1.8;
    color: #333;
}
...
/* Sections */
.items-section, .transaction-section {
    margin-bottom: 40px;
}
